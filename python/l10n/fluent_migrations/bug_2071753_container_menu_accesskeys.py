...
user-context-personal2-panel-item = {COPY_PATTERN(from_path, "user-context-personal-panel-item")}
user-context-work2-panel-item = {COPY_PATTERN(from_path, "user-context-work-panel-item")}
user-context-banking2-panel-item = {COPY_PATTERN(from_path, "user-context-banking-panel-item")}
user-context-shopping2-panel-item = {COPY_PATTERN(from_path, "user-context-shopping-panel-item")}
