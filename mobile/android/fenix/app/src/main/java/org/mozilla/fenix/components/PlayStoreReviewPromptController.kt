...
class PlayStoreReviewPromptController(
    ...
    suspend fun tryPromptReview(activity: Activity): ReviewPromptAttemptResult {
        ...
        when (result) {
            ...
            is Error -> {
                val reviewErrorCode = (result.exception as? ReviewException)?.errorCode ?: ERROR_CODE_UNEXPECTED
    ...
    fun tryLaunchPlayStoreReview(
        ...
        try {
            ...
            activity.startActivity(Intent(Intent.ACTION_VIEW, SupportUtils.RATE_APP_URL.toUri()))
