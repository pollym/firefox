...
import mozilla.components.feature.tabgroups.storage.data.toStoredTabGroup
import mozilla.components.feature.tabgroups.storage.data.toTabGroup
import mozilla.components.feature.tabgroups.storage.database.TabGroupAssignment
import mozilla.components.feature.tabgroups.storage.database.TabGroupDatabase
...
class DefaultTabGroupRepository : TabGroupRepository {
    ...
    /**
     * The test implementation of [TabGroupRepository]. Use `createTestTabGroupRepository` from the module's test
     * fixtures to access this outside of this module.
     *
    ...
    internal constructor(
        ...
        this.database = database as TabGroupDatabase
        this.dateTimeProvider = dateTimeProvider
    }
