   ...
   internal fun setValue(other: RustBuffer) {
    ...
    companion object {
        internal fun alloc(size: ULong = 0UL) = uniffiRustCall() { status ->
            ...
            UniffiLib.ffi_places_rustbuffer_alloc(size.toLong(), status)
        }.also {
            if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = uniffiRustCall() { status ->
            UniffiLib.ffi_places_rustbuffer_free(buf, status)
        }
    }
...
internal object IntegrityCheckingUniffiLib {
    init {
        Native.register(IntegrityCheckingUniffiLib::class.java, findLibraryName(componentName = "places"))
...
internal object UniffiLib {
    ...
    init {
        Native.register(UniffiLib::class.java, findLibraryName(componentName = "places"))
...
open class PlacesApi: Disposable, AutoCloseable, PlacesApiInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_places_fn_free_placesapi(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_places_fn_clone_placesapi(handle, status)
        }
    }
    ...
    UniffiLib.uniffi_places_fn_method_placesapi_register_with_sync_manager(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypePlacesApi: FfiConverter<PlacesApi, Long> {
    override fun lower(value: PlacesApi): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): PlacesApi {
        return PlacesApi(UniffiWithHandle, value)
    }
...
public interface PlacesConnectionInterface {
    ...
    fun `getMostRecentHistoryMetadata`(`limit`: kotlin.Int): List<HistoryMetadata>
    
    fun `getMostRecentSearchEntriesInHistoryMetadata`(`limit`: kotlin.Int): List<HistoryMetadata>
...
open class PlacesConnection: Disposable, AutoCloseable, PlacesConnectionInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_places_fn_free_placesconnection(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_places_fn_clone_placesconnection(handle, status)
        }
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(PlacesApiException) { _status ->
    UniffiLib.uniffi_places_fn_method_placesconnection_bookmarks_delete_everything(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCallWithError(PlacesApiException) { _status ->
    UniffiLib.uniffi_places_fn_method_placesconnection_delete_everything_history(
        it,
        _status)
}
    }
    ...
    @Throws(PlacesApiException::class)override fun `getMostRecentHistoryMetadata`(`limit`: kotlin.Int): List<HistoryMetadata> {
            return FfiConverterSequenceTypeHistoryMetadata.lift(
    callWithHandle {
    uniffiRustCallWithError(PlacesApiException) { _status ->
    ...
    @Throws(PlacesApiException::class)override fun `getMostRecentSearchEntriesInHistoryMetadata`(`limit`: kotlin.Int): List<HistoryMetadata> {
            return FfiConverterSequenceTypeHistoryMetadata.lift(
    callWithHandle {
    uniffiRustCallWithError(PlacesApiException) { _status ->
    ...
    @Throws(PlacesApiException::class)override fun `metadataDeleteSearchTerms`()
        = 
    callWithHandle {
    uniffiRustCallWithError(PlacesApiException) { _status ->
    UniffiLib.uniffi_places_fn_method_placesconnection_metadata_delete_search_terms(
        it,
        _status)
}
    }
    ...
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_places_fn_method_placesconnection_new_interrupt_handle(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypePlacesConnection: FfiConverter<PlacesConnection, Long> {
    override fun lower(value: PlacesConnection): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): PlacesConnection {
        return PlacesConnection(UniffiWithHandle, value)
    }
...
open class SqlInterruptHandle: Disposable, AutoCloseable, SqlInterruptHandleInterface
{
    ...
    private class UniffiCleanAction(private val handle: Long) : Runnable {
        override fun run() {
            ...
            uniffiRustCall { status ->
                UniffiLib.uniffi_places_fn_free_sqlinterrupthandle(handle, status)
            }
        }
    }
    ...
    fun uniffiCloneHandle(): Long {
        ...
        return uniffiRustCall() { status ->
            UniffiLib.uniffi_places_fn_clone_sqlinterrupthandle(handle, status)
        }
    }
    ...
    callWithHandle {
    uniffiRustCall() { _status ->
    UniffiLib.uniffi_places_fn_method_sqlinterrupthandle_interrupt(
        it,
        _status)
}
    }
 ...
 * @suppress
 */
public object FfiConverterTypeSqlInterruptHandle: FfiConverter<SqlInterruptHandle, Long> {
    override fun lower(value: SqlInterruptHandle): Long {
        return value.uniffiCloneHandle()
    }

    override fun lift(value: Long): SqlInterruptHandle {
        return SqlInterruptHandle(UniffiWithHandle, value)
    }
...
sealed class BookmarkItem {
    ...
    data class Bookmark(
        val `b`: mozilla.appservices.places.uniffi.BookmarkData) : BookmarkItem()
    ...
    data class Separator(
        val `s`: mozilla.appservices.places.uniffi.BookmarkSeparator) : BookmarkItem()
    ...
    data class Folder(
        val `f`: mozilla.appservices.places.uniffi.BookmarkFolder) : BookmarkItem()
...
sealed class InsertableBookmarkItem {
    ...
    data class Bookmark(
        val `b`: mozilla.appservices.places.uniffi.InsertableBookmark) : InsertableBookmarkItem()
    ...
    data class Folder(
        val `f`: mozilla.appservices.places.uniffi.InsertableBookmarkFolder) : InsertableBookmarkItem()
    ...
    data class Separator(
        val `s`: mozilla.appservices.places.uniffi.InsertableBookmarkSeparator) : InsertableBookmarkItem()
