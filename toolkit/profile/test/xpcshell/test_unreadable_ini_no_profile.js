...
/*
 * Tests that an unreadable profiles.ini prevents automatic profile selection
 * when no explicit profile is given.
 */
...
add_task(async () => {
  ...
  // Without an explicit profile, startup should fail with a specific error.
  try {
