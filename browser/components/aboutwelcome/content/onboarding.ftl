...
fx-backup-opt-in-filepath-label = Pick a location you plan to transfer to a new device, like OneDrive.
...
create-backup-screen-1-sync-body = Back up on all signed in devices
create-backup-screen-1-backup-label = Back up to PC
create-backup-screen-1-backup-body = Save to this device
