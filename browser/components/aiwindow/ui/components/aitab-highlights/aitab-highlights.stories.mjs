...
export default {
  heading: "Domain-specific UI Widgets/AI Window/AI Tab Highlights",
...
const Template = ({ heading, items }) => html`
  <aitab-highlights .heading=${heading} .items=${items}></aitab-highlights>
`;
...
LongText.args = {
  heading:
    "A heading long enough to wrap onto a second line inside the rounded card",
  items: [
    {
