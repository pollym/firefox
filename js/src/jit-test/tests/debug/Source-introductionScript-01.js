...
assertEq(introducer.getOffsetMetadata(introduced.introductionOffset).lineNumber, 1812);
...
assertEq(log, 'de1de2');
assertEq(introduced.introductionScript, introducer);
assertEq(introducer.getOffsetMetadata(introduced.introductionOffset).lineNumber, 1066);
...
dbg.onDebuggerStatement = function (frame) {
  ...
  dbg.onDebuggerStatement = function (frame) {
    ...
    assertEq(outerScript.getOffsetMetadata(source.introductionOffset).lineNumber,
             outerScript.getOffsetMetadata(outerOffset).lineNumber);
  };
};
log = '';
...
assertEq(introducer.getOffsetMetadata(source.introductionOffset).lineNumber, 1685);
