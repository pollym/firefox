...
2. {searchfox}`Category pair name <__GENERATED__/mozglue/baseprofiler/public/ProfilingCategoryList.h>`
   ...
   (Internally, this is really a [MarkerCategory](https://searchfox.org/mozilla-central/define?q=T_mozilla%3A%3AMarkerCategory)
   object, in case you need to construct it elsewhere.)
3. [MarkerOptions](https://searchfox.org/mozilla-central/define?q=T_mozilla%3A%3AMarkerOptions)
   ...
   - [MarkerThreadId](https://searchfox.org/mozilla-central/define?q=T_mozilla%3A%3AMarkerThreadId)
   ...
   - [MarkerTiming](https://searchfox.org/mozilla-central/define?q=T_mozilla%3A%3AMarkerTiming)
   ...
   - [MarkerStack](https://searchfox.org/mozilla-central/define?q=T_mozilla%3A%3AMarkerStack)
   ...
   - [MarkerInnerWindowId](https://searchfox.org/mozilla-central/define?q=T_mozilla%3A%3AMarkerInnerWindowId)
...
[RAII](https://en.cppreference.com/w/cpp/language/raii) objects automate this, by recording the time
...
`AUTO_PROFILER_MARKER_UNTYPED` and `AUTO_PROFILER_MARKER_TEXT` are the [only](https://searchfox.org/mozilla-central/search?q=id%3AAUTO_PROFILER_MARKER_UNTYPED)
[ones](https://searchfox.org/mozilla-central/search?q=id%3AAUTO_PROFILER_MARKER_TEXT)
...
- Most C/C++ [POD (Plain Old Data)](https://en.cppreference.com/w/cpp/named_req/PODType)
  and [trivially-copyable](https://en.cppreference.com/w/cpp/named_req/TriviallyCopyable)
...
- Other types can be used if they define specializations for `ProfileBufferEntryWriter::Serializer`
  ...
  [perf-tools team for help](https://chat.mozilla.org/#/room/#profiler:mozilla.org).
...
full list](https://searchfox.org/mozilla-central/define?q=T_mozilla%3A%3AMarkerSchema%3A%3ALocation).
