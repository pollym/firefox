...
interface GleanImpl {
  ...
  smartWindow: {
    ...
    formFillClassifyRequest: GleanEventWithExtras<{ fields_total?: string, flow_id?: string, model?: string, prompt_version?: string, trigger?: string }>;
    formFillClassifyResponse: GleanEventWithExtras<{ error?: string, error_message?: string, flow_id?: string, latency_ms?: string, page_type?: string }>;
    formFillField: GleanEventWithExtras<{ confidence?: string, field_kind?: string, field_seq?: string, filled?: string, flow_id?: string, input_type?: string, source?: string, token_available?: string, token_kind?: string }>;
    formFillFieldOutcome: GleanEventWithExtras<{ confidence?: string, field_kind?: string, field_seq?: string, flow_id?: string, outcome?: string, source?: string }>;
    formFillGenerateRequest: GleanEventWithExtras<{ flow_id?: string, memories?: string, model?: string, prompt_version?: string, tabs?: string, threshold?: string, tokens_available?: string }>;
    formFillGenerateResponse: GleanEventWithExtras<{ batches_failed?: string, batches_total?: string, error?: string, error_message?: string, fields_filled?: string, flow_id?: string, latency_ms?: string, memories_used?: string, tabs_used?: string }>;
    formRelevantTabsRequest: GleanEventWithExtras<{ flow_id?: string, model?: string, prompt_version?: string, tabs_sent?: string }>;
    formRelevantTabsResponse: GleanEventWithExtras<{ error?: string, error_message?: string, flow_id?: string, latency_ms?: string, tabs_selected?: string, tabs_used?: string }>;
    ...
    launchCommandInvoked: GleanEventWithExtras<{ fxa?: string, new_window?: string, trigger?: string }>;
  ...
  genaiLinkpreview: {
    ...
    smokeTest: GleanEventWithExtras<{ flow_id?: string, matches_pinned?: string, model_id?: string, model_revision?: string, output_hash?: string }>;
  ...
  newtab: {
    ...
    carouselNavigate: GleanEventWithExtras<{ direction?: string, newtab_visit_id?: string, section?: string, section_position?: string, slide_index?: string }>;
    carouselToggleAutoplay: GleanEventWithExtras<{ newtab_visit_id?: string, paused?: string, section?: string, section_position?: string }>;
  ...
  newtabContent: {
    click: GleanEventWithExtras<{ corpus_item_id?: string, format?: string, is_section_followed?: string, is_sponsored?: string, layout_name?: string, matches_selected_topic?: string, position?: string, received_rank?: string, recommended_at?: string, scheduled_corpus_item_id?: string, section?: string, selected_topics?: string, tile_id?: string, topic?: string }>;
    ...
    impression: GleanEventWithExtras<{ corpus_item_id?: string, format?: string, is_section_followed?: string, is_sponsored?: string, layout_name?: string, position?: string, received_rank?: string, recommended_at?: string, scheduled_corpus_item_id?: string, section?: string, selected_topics?: string, tile_id?: string, topic?: string }>;
  ...
  shareButton: {
    impression: GleanEventWithExtras<{ action?: string, is_shareable?: string }>;
  }
  ...
  uiDensity: {
    mode: GleanEventWithExtras<{ auto_adjustments_prior?: string, current?: string, device_pixel_ratio?: string, effective?: string, on_startup?: string, previous?: string, touch_capable?: string, window_height?: string, window_width?: string }>;
  }
  ...
  formautofillAddresses: {
    ...
    migrateToRust: GleanEventWithExtras<{ attempt?: string, direction?: string, diverged?: string, duration_ms?: string, error_code?: string, error_message?: string, failed?: string, failed_deletions?: string, migrated?: string, result?: string, run_id?: string, source_total?: string, target_total?: string }>;
  }
  ...
  firefoxAiRuntime: {
    ...
    engineRun: GleanEventWithExtras<{ average_chunk_time?: string, backend?: string, backend_source_revision?: string, character_count?: string, cores?: string, cpu_milliseconds?: string, cpu_utilization?: string, engine_id?: string, feature_id?: string, flow_id?: string, memory_bytes?: string, model_id?: string, system_memory_mb?: string, time_to_first_chunk?: string, token_count?: string, wall_milliseconds?: string }>;
  ...
  nimbusEvents: {
    ...
    updateError: GleanEventWithExtras<{ during_shutdown?: string, error?: string, trigger?: string }>;
  ...
  pwmgr: {
    ...
    rustRestoreStatus: GleanEventWithExtras<{ attempt?: string, duration_ms?: string, end_state?: string, error_message?: string, metric_version?: string, number_of_logins_added?: string, number_of_logins_failed?: string, number_of_logins_skipped?: string, number_of_logins_to_restore?: string, number_of_logins_updated?: string, primary_password_set?: string, run_id?: string, state?: string }>;
